...
<?php
$old_fname=$old_uname=$old_email=$old_pass=$old_img=$old_country=$old_details="";
...
$sql = "SELECT * FROM signup_user where id='$ids' ";
...
$img  =($_FILES['img']);
   ...
   if((isset($fname) || $fname=="") && (isset($uname) || $uname=="") && (isset($email) || $email=="") && (isset($pass) || $pass=="") && (isset($cpass) || $cpass=="") && (isset($img) || $img=="")){
	...
	$stu_querry = "update `signup_user` set fname='$fname',uname='$uname',email='$email',gender='$gender',country='$country',password='$pass',details='$details',img='$img_path' where id=$ids"; 
...
<div class="forms">
  ...
  <span style="color: red;"><?php echo $pass_error; ?></span>
    <input type="password" name="pass" value="<?php echo $old_pass; ?>"  placeholder="enter password *"  id="pass" > 
	  
  </div>
  <div class="form-group "><span style="color: red;"><?php echo $cpass_error; ?></span>
    <input type="password" name="cpass" value="<?php echo $old_pass; ?>"  placeholder="Confirm password *"  id="cpass" > 
...
<div class="form-group">
 ...
 <a  style="width: 100%;margin-top: 10px;" href="view_signup.php" class="btn btn-primary">VIEW RECORDS</a>
